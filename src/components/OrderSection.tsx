    ...
    <section id="order-section" className="relative overflow-hidden py-16 md:py-24 bg-white border-y border-slate-100">
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-12">
          <span className="inline-block text-sm font-bold uppercase tracking-wider text-[#0068FF] bg-blue-50 px-4 py-1.5 rounded-full border border-blue-100 mb-3 sm:mb-4">
            সহজ ও দ্রুত অর্ডার
          </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-6 space-y-4">
            ...
            {/* Color Swatch Card */}
            <div className="bg-slate-50/70 rounded-3xl p-5 sm:p-6 border border-slate-200 shadow-xs space-y-3.5">
                ...
                {COLOR_VARIANTS.map((variant) => {
                  ...
                  return (
                    <button
                      ...
                      className={`relative flex flex-col items-center p-3 sm:p-3.5 rounded-2xl border-2 transition-all cursor-pointer bg-white ${isSelected
                        ? 'border-[#0068FF] ring-3 ring-[#0068FF]/20 shadow-md scale-101'
                        : 'border-slate-200/90 hover:border-slate-300'
                        }`}
                    >
                      <div className="w-16 h-16 sm:w-18 sm:h-18 rounded-xl overflow-hidden mb-2 bg-slate-100 border border-slate-100">
                        <img
                          src={variant.image}
                          alt={variant.name}
                      ...
                      {isSelected && (
                        <span className="absolute top-2 right-2 w-5.5 h-5.5 rounded-full bg-[#0068FF] text-white flex items-center justify-center shadow-xs">
              ...
              <div className="pt-3 border-t border-slate-200 flex items-center justify-between">
                <div>
                  <h4 className="text-sm sm:text-base font-bold text-slate-900">২. পরিমাণ (Quantity)</h4>
                  <p className="text-xs text-slate-500">কত পিস নিতে চান?</p>
                </div>
                ...
                <div className="flex items-center bg-white border border-slate-300 rounded-xl p-1 shadow-2xs">
                  <button
                    ...
                    disabled={quantity <= 1}
                    className="w-8.5 h-8.5 rounded-lg flex items-center justify-center text-slate-700 hover:bg-slate-100 disabled:opacity-30 disabled:hover:bg-transparent transition-colors cursor-pointer"
            ...
            <div className="bg-[linear-gradient(135deg,#0A58CA_0%,#0068FF_35%,#0284C7_70%,#06B6D4_100%)] text-white rounded-3xl p-5 sm:p-6 healis-shadow-lg space-y-3.5 border border-white/20">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <label className="block text-sm font-bold text-white flex items-center gap-1.5">
                    <FiTruck className="w-4 h-4 text-cyan-200" />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                  ...
                  <button
                    ...
                    className={`text-left p-3 rounded-2xl border transition-all cursor-pointer relative flex items-center justify-between ${
                      deliveryArea === 'dhaka'
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      >
                        {deliveryArea === 'dhaka' && <FiCheck className="w-3 h-3 stroke-[3]" />}
                      </div>
                      <div>
                        <p className={`text-sm font-bold leading-tight ${deliveryArea === 'dhaka' ? 'text-slate-900' : 'text-white'}`}>
                          ঢাকা শহর
                        </p>
                        <p className={`text-[11px] ${deliveryArea === 'dhaka' ? 'text-slate-500' : 'text-blue-100'}`}>
                          ২৪-৪৮ ঘণ্টার মধ্যে
                        </p>
                      </div>
                    </div>
                    ...
                    <span
                      className={`text-xs font-extrabold px-2.5 py-0.5 rounded-lg shrink-0 ${
                        deliveryArea === 'dhaka'
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      >
                        {deliveryArea === 'outside' && <FiCheck className="w-3 h-3 stroke-[3]" />}
                      </div>
                      <div>
                        <p className={`text-sm font-bold leading-tight ${deliveryArea === 'outside' ? 'text-slate-900' : 'text-white'}`}>
                          ঢাকার বাইরে
                        </p>
                        <p className={`text-[11px] ${deliveryArea === 'outside' ? 'text-slate-500' : 'text-blue-100'}`}>
                          সারা বাংলাদেশে
                        </p>
                      </div>
                    </div>
              ...
              <div className="space-y-2 text-sm sm:text-base pt-2.5 border-t border-white/25">
                ...
                <div className="pt-2.5 border-t border-white/25 flex justify-between items-center text-base sm:text-lg">
          ...
          <div className="lg:col-span-6">
            <div className="bg-slate-50/70 rounded-3xl p-5 sm:p-6 lg:p-7 border border-slate-200 shadow-sm">
              ...
              <form onSubmit={handleSubmit} className="space-y-3.5 sm:space-y-4" noValidate>
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-2xl bg-white border text-base text-slate-900 placeholder:text-slate-400 focus:outline-hidden focus:ring-2 focus:ring-[#0068FF] transition-all ${errors.name ? 'border-red-500 ring-1 ring-red-500' : 'border-slate-300'
                      }`}
                  />
                  {errors.name && (
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-2xl bg-white border text-base text-slate-900 placeholder:text-slate-400 focus:outline-hidden focus:ring-2 focus:ring-[#0068FF] transition-all ${errors.phone ? 'border-red-500 ring-1 ring-red-500' : 'border-slate-300'
                      }`}
                  />
                  {errors.phone && (
                    <p className="text-xs sm:text-sm text-red-600 flex items-center gap-1 mt-1">
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    className={`w-full px-4 py-3 rounded-2xl bg-white border text-base text-slate-900 placeholder:text-slate-400 focus:outline-hidden focus:ring-2 focus:ring-[#0068FF] transition-all resize-none ${errors.address ? 'border-red-500 ring-1 ring-red-500' : 'border-slate-300'
                      }`}
                  />
                  {errors.address && (
                    <p className="text-xs sm:text-sm text-red-600 flex items-center gap-1 mt-1">
                ...
                <div className="flex items-center justify-between p-3 rounded-2xl bg-blue-50/60 border border-blue-100">
                  ...
                  <span className="text-sm font-bold text-[#0068FF] bg-white px-3 py-0.5 rounded-xl border border-blue-200/80 shadow-2xs">
                    {deliveryArea === 'dhaka' ? 'ঢাকা শহর' : 'ঢাকার বাইরে'}
                  </span>
                </div>
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-blue bg-gradient-blue-hover text-white text-sm sm:text-base font-bold py-3.5 px-5 sm:px-6 rounded-2xl transition-all duration-200 shadow-md hover:shadow-lg active:scale-98 flex items-center justify-center gap-2 cursor-pointer mt-1"
                >
